...
class KummerSurface(AlgebraicScheme_subscheme_projective):
    ...
    def _mumford_to_kummer(self, P):
        ...
        if u2 == R.one():
            ...
            h1h2 = h3**2 * u0**3 + (-h2 * h3) * u0**2 * u1 + (h2**2 - 2 * h1 * h3) * u0**2 + h1 * h3 * u0 * u1**2 + \
                (-h1 * h2 + 3 * h0 * h3) * u0 * u1 + (h1**2 - 2 * h0 * h2) * u0 + (-h0 * h3) * u1**3 + h0 * h2 * u1**2 + (-h0 * h1) * u1 + h0**2

            if u1**2 - 4 * u0 == 0:
                # divisor of the form [2*P - D_infty] with P = [-u1/2,v0]
                # TODO: Is this formula correct?
                denom = 4 * ((4 * f6 + h3**2) * u1**6 + (-8 * f5 - 4 * h2 * h3) * u1**5 + (16 * f4 + 8 * h1 * h3 + 4 * h2**2) * u1**4 + (-32 * f3 - 16 *
                             h0 * h3 - 16 * h1 * h2) * u1**3 + (64 * f2 + 32 * h0 * h2 + 16 * h1**2) * u1**2 + (-128 * f1 - 64 * h0 * h1) * u1 + (256 * f0 + 64 * h0**2))
                x0 = denom
                x1 = - u1 * denom
                x2 = u0 * denom
                x3 = (-1) * (
                    (4 * f4 * f6 + f4 * h3**2 - f5**2 - f5 * h2 * h3 + f6 * h2**2) * u1**8 + (
                        -16 * f3 * f6 - 4 * f3 * h3**2 + 4 * f5 * h1 * h3 - 8 * f6 * h1 * h2) * u1**7 + (
                        64 * f2 * f6 + 16 * f2 * h3**2 + 8 * f3 * f5 + 4 * f3 * h2 * h3 - 8 * f4 * h1 * h3 - 12 * f5 * h0 * h3 + 4 * f5 * h1 * h2 + 24 * f6 * h0 * h2 + 16 * f6 * h1**2) * u1**6 + (
                        -192 * f1 * f6 - 48 * f1 * h3**2 - 64 * f2 * f5 - 32 * f2 * h2 * h3 + 16 * f3 * h1 * h3 + 32 * f4 * h0 * h3 - 16 * f5 * h0 * h2 - 16 * f5 * h1**2 - 96 * f6 * h0 * h1) * u1**5 + (
                        576 * f0 * f6 + 144 * f0 * h3**2 + 224 * f1 * f5 + 112 * f1 * h2 * h3 + 64 * f2 * f4 + 16 * f2 * h2**2 - 16 * f3**2 - 80 * f3 * h0 * h3 - 16 * f3 * h1 * h2 + 16 * f4 * h1**2 + 112 * f5 * h0 * h1 + 144 * f6 * h0**2) * u1**4 + (
                        -768 * f0 * f5 - 384 * f0 * h2 * h3 - 256 * f1 * f4 - 64 * f1 * h1 * h3 - 64 * f1 * h2**2 + 128 * f2 * h0 * h3 + 64 * f3 * h0 * h2 - 128 * f4 * h0 * h1 - 192 * f5 * h0**2) * u1**3 + (
                        1024 * f0 * f4 + 384 * f0 * h1 * h3 + 256 * f0 * h2**2 + 128 * f1 * f3 - 192 * f1 * h0 * h3 + 64 * f1 * h1 * h2 - 128 * f2 * h0 * h2 + 64 * f3 * h0 * h1 + 256 * f4 * h0**2) * u1**2 + (
                        -1024 * f0 * f3 - 512 * f0 * h1 * h2 + 256 * f1 * h0 * h2 - 256 * f3 * h0**2) * u1 + (
                        1024 * f0 * f2 + 256 * f0 * h1**2 - 256 * f1**2 - 256 * f1 * h0 * h1 + 256 * f2 * h0**2))
            elif y1y2 == R.zero():
                ...
                x1 = - u1 * denom
                x2 = u0 * denom
                term = (-f5**2 + 4 * f4 * f6) * u0**4 + (-4 * f3 * f6) * u0**3 * u1 + 2 * f3 * f5 * u0**3 + 4 * f2 * f6 * u0**2 * u1**2 + (-4 * f2 * f5 + 4 * f1 * f6) * u0**2 * u1 + (-f3**2 + 4 * f2 * f4 - 2 * f1 * f5 + 4 * f0 * f6) * u0**2 + \
                    (-4 * f1 * f6) * u0 * u1**3 + (4 * f1 * f5 - 8 * f0 * f6) * u0 * u1**2 + (-4 * f1 * f4 + 4 * f0 * f5) * u0 * u1 + 2 * f1 * \
                    f3 * u0 + 4 * f0 * f6 * u1**4 + (-4 * f0 * f5) * u1**3 + 4 * f0 * f4 * u1**2 + (-4 * f0 * f3) * u1 - f1**2 + 4 * f0 * f2
            ...
            x1 = X2**3 * Z1**3
            x2 = X1 * X2**3 * Z1**2
            x3 = - (2 * Y1 * Y2 + h3 * Y1 * X2**3 + Y2 * (h3 * X1**3 + h2 * X1**2 * Z1 + h1 *
                    X1 * Z1**2 + h0 * Z1**3) - 2 * f6 * X1**3 * X2**3 - f5 * X1**2 * X2**3 * Z1)
        else:
